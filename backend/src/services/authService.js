    ...
    return {
      ...
      user: {
        ...
        alumni: user.alumni ? {
          ...
          isStudentIdPublic: user.alumni.is_student_id_public,
          is_student_id_public: user.alumni.is_student_id_public,
          isDateOfBirthPublic: user.alumni.is_date_of_birth_public,
          is_date_of_birth_public: user.alumni.is_date_of_birth_public,
          isCoursePublic: user.alumni.is_course_public,
          is_course_public: user.alumni.is_course_public,
          isGraduationYearPublic: user.alumni.is_graduation_year_public,
          is_graduation_year_public: user.alumni.is_graduation_year_public,
          isEducationHistoryPublic: user.alumni.is_education_history_public,
          is_education_history_public: user.alumni.is_education_history_public,
          isEmailPublic: user.alumni.is_email_public,
          is_email_public: user.alumni.is_email_public,
          isPhonePublic: user.alumni.is_phone_public,
          is_phone_public: user.alumni.is_phone_public,
          isPositionPublic: user.alumni.is_position_public,
          is_position_public: user.alumni.is_position_public,
          isEmploymentPublic: user.alumni.is_employment_public,
          is_employment_public: user.alumni.is_employment_public,
          isCompanyPublic: user.alumni.is_company_public,
          is_company_public: user.alumni.is_company_public,
          isLocationPublic: user.alumni.is_location_public,
          is_location_public: user.alumni.is_location_public,
          isSocialLinksPublic: user.alumni.is_social_links_public,
          is_social_links_public: user.alumni.is_social_links_public,
          isSkillsPublic: user.alumni.is_skills_public,
          is_skills_public: user.alumni.is_skills_public
        } : null
      }
    };
  } catch (error) {
