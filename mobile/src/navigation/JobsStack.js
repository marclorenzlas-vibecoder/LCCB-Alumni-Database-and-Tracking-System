...
export default function JobsStack({ user }) {
  return (
    ...
    >
      ...
      >
        {(props) => <JobsListScreen {...props} user={user} />}
      </Stack.Screen>
      <Stack.Screen name="JobDetail" options={{ title: 'Job Details' }}>
        {(props) => <JobDetailScreen {...props} user={user} />}
      </Stack.Screen>
      <Stack.Screen name="JobApplication" options={{ title: 'Apply for Job' }}>
        {(props) => <JobApplicationScreen {...props} user={user} />}
      </Stack.Screen>
      <Stack.Screen name="MyApplications" options={{ title: 'My Applications' }}>
        {(props) => <MyApplicationsScreen {...props} user={user} />}
      </Stack.Screen>
    </Stack.Navigator>
  );
}
